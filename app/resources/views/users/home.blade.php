...
@section('content')
    ...
    <main class="main">
        <section class="home-slider position-relative" style="background-color:#d0f3ec">
                    ...
                    <div class="single-hero-slider single-animation-wrap">
                        <div class="container">
                            <div class="slider-1-height-2 slider-animated-1">
                                <div class="hero-slider-content-2" style="padding-left:10px">
                                    <h5 class="animated">{{ $slider->secondname }}</h5>
                                    {{-- <h3 class="animated fw-900"></h3> --}}
                                    <h3 class="animated fw-900 text-brand">{{ $slider->thirdname }}</h3>
                                    <a class="animated btn btn-brush btn-brush-1" href="{{ url('pages/products') }}"> Shop
                                        Now </a>
                                </div>
                                <div class="single-slider-img single-slider-img-1">
                                    <img class="animated" src="{{ asset('/images/sliders/' . $slider->image) }}"
                                        alt="">
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="product-img-action-wrap">
                                                    ...
                                                    <div class="product-action-1">
                                                        <a aria-label="Quick view"
                                                            href="{{ route('product-details', $pro->id) }}"
            ...
            <div class="container">
                <div class="row">
                    @foreach ($categories as $cats)
                        <div class="col-lg-6 deal-co mb-10 mt-10 mb-10">
                            <div class="deal wow fadeIn animated mb-md-4 mb-sm-4 mb-lg-0 animated animated"
                                style="background-image: url('{{ asset('/images/category/' . $cats->image) }}'); visibility: visible;">


                                <div class="deal-bottom" style="float: right;">
                                    <div class="deal-top">
                                ...
                                <div class="carausel-4-columns-cover arrow-center position-relative">
                                    ...
                                    <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns">
                                        ...
                                        <div class="product-cart-wrap">
                                            ...
                                            <div class="product-content-wrap">
                                                <div class="product-category">
                                                    <a href="{{ route('product-details', $items->id) }}">{{$items->category->name}}</a>
                                                </div>
                                                <h2><a href="{{ route('product-details', $items->id) }}">{{$items->name}}</a></h2>
                                                ...
                                                <div class="product-action-1 show">
                                                    <a aria-label="Add To Cart" class="action-btn hover-up" href="{{ route('product-details', $items->id) }}"><i class="fi-rs-shopping-bag-add"></i></a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                            @foreach ($recents as $recent)
                                <div class="product-cart-wrap small hover-up">
                                    ...
                                    <div class="product-content-wrap">
                                        <h2><a href="{{ route('product-details', $recent->id) }}">
                                                {{ $recent->name }}</a></h2>
